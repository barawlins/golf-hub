...
export const COURSES: Course[] = [
  // ═══════════════════════════════════════════════════
  // THE BEAR — Jack Nicklaus Signature Design
  // Par 72 | Grand Traverse Resort & Spa
  // Source: Official Bear Scorecard (02/2022)
  // ═══════════════════════════════════════════════════
  buildCourse("The Bear", "The Bear", 72, [
    {
      ...
      holes: {
        ...
        11: { par: 4, yardage: 421 },
        12: { par: 4, yardage: 413 },
        13: { par: 3, yardage: 167 },
        14: { par: 4, yardage: 390 },
        15: { par: 5, yardage: 543 },
        16: { par: 4, yardage: 451 },
        17: { par: 3, yardage: 220 },
        18: { par: 4, yardage: 467 },
      }
    },
    {
  ...
  // ═══════════════════════════════════════════════════
  // THE WOLVERINE — Gary Player Signature Design
  // Par 72 | Grand Traverse Resort & Spa
  // ═══════════════════════════════════════════════════
  ...
  // ═══════════════════════════════════════════════════
  // SPRUCE RUN
  // Par 70 | Grand Traverse Resort & Spa
  // ═══════════════════════════════════════════════════
